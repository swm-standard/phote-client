...
const Banner = () => {
  return (
    <div className="mt-4 flex w-full items-center justify-between overflow-hidden rounded-[20px] bg-banner-bg px-6 py-6">
      <div className="flex flex-col gap-2.5">
        <p className="text-lg font-semibold text-text-001">
          함께 포테를 만들어나가요!
        </p>
